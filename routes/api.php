...
Route::prefix('v1')->namespace('Api')->name('api.v1.')
    ...
    ->group(function () {
        ...
        // 登录以后可以访问的接口
            ...
            Route::get('users/{user}/replies', 'RepliesController@userIndex')->name('users.replies.index'); // 话题回复列表
            ...
            Route::put('user/read/notifications', 'NotificationsController@read')->name('user.notifications.read.put'); // 标记消息通知已读
